...
static const char *const kBuiltinFunctionNames[] = {
    ...
    "INPUTBASEN", "INSERT", "INT", "INTERRUPTTHREAD", "INVALIDATEOAUTHACCESSTOKEN", "INVOKE", "ISARRAY",
    "ISBINARY", "ISBOOLEAN", "ISCLOSURE", "ISDATE", "ISDATEOBJECT", "ISDDX", "ISDEBUGMODE",
    ...
    "ISPDFARCHIVE", "ISPDFFILE", "ISPDFOBJECT", "ISQUERY", "ISSAFEHTML", "ISSAMLLOGOUTRESPONSE", "ISSIMPLEVALUE",
