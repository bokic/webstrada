...
llvm_codegen::llvm_codegen()
{
    ...
    llvm::sys::DynamicLibrary::AddSymbol("cf_mail_tag", reinterpret_cast<void*>(cfml::cf_mail_tag));
    llvm::sys::DynamicLibrary::AddSymbol("cf_mailpart_tag", reinterpret_cast<void*>(cfml::cf_mailpart_tag));
    llvm::sys::DynamicLibrary::AddSymbol("cf_mailparam_tag", reinterpret_cast<void*>(cfml::cf_mailparam_tag));
