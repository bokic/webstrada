# Research: SPREADSHEETFORMATCOLUMNS cffunction implementation notes
...
- Runtime stub: `cfml::cf_spreadsheetformatcolumns()` in `src/cf8.cpp:15968` throws `"Function SPREADSHEETFORMATCOLUMNS is not implemented"`.
- Compiler: `SPREADSHEETFORMATCOLUMNS` is in the zero-arg not-implemented function list (`src/compiler.cpp:1745`).
- No interpreter (`evalFunction`) dispatch entry.
- Symbol registered at `src/compiler.cpp:5647`.
...
|------|--------|----------|
| Runtime | ❌ Stub that throws | `src/cf8.cpp:15968` |
| Compiler wiring | ⚠️ Compiled as zero-arg call into the not-implemented list; no args compiled/passed | `src/compiler.cpp:1745`, symbol at `src/compiler.cpp:5647` |
| Interpreter dispatch | ❌ Missing | — |
| Tag support | N/A (function only) | — |
| Tests | ❌ No `tests/cfm/*spreadsheetformatcolumns*`, no `verify_with_coldfusion.py` coverage | — |
| Tracker status | ❌ `PROGRESS.md:747` (❌ No), listed in `UNIMPLEMENTED_FUNCTIONS.md` (Spreadsheet*) | — |
| Docs/spec | ✅ Spec reference exists | `cfml_docs/CFML_FUNCTION_SPREADSHEETFORMATCOLUMNS.md` |

## What SPREADSHEETFORMATCOLUMNS does at the low C level

Formats a range of columns of a spreadsheet with the given style options.
