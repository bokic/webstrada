# Research: ISIPV6 cffunction implementation notes
...
> Implemented (2026-08-08): `cf_isipv6` in `src/cffunctions/`, a direct JIT call in
...
- Runtime stub: `cfml::cf_isipv6()` in `src/cf8.cpp:14148` throws `"Function ISIPV6 is not implemented"`.
- Compiler: `ISIPV6` is in the zero-arg not-implemented function list (`src/compiler.cpp:1740`).
- No interpreter (`evalFunction`) dispatch entry.
- Symbol registered at `src/compiler.cpp:5484`.
...
| Docs/spec | ✅ Spec reference exists | `cfml_docs/CFML_FUNCTION_ISIPV6.md` |

## What ISIPV6 does at the low C level
...
```cpp
cfvariant *cf_isipv6(const cfvariant *a1);
```
...
IPv6 parser. Unit tests + tracker updates.

## Ease of implementation

Easy-to-moderate. Address-family parsing (inet_pton).
