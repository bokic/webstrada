# Research: SPREADSHEETFORMATCELLRANGE cffunction implementation notes
...
- Runtime stub: `cfml::cf_spreadsheetformatcellrange()` in `src/cf8.cpp:15960` throws `"Function SPREADSHEETFORMATCELLRANGE is not implemented"`.
- Compiler: `SPREADSHEETFORMATCELLRANGE` is in the zero-arg not-implemented function list (`src/compiler.cpp:1745`).
- No interpreter (`evalFunction`) dispatch entry.
- Symbol registered at `src/compiler.cpp:5645`.
...
|------|--------|----------|
| Runtime | ❌ Stub that throws | `src/cf8.cpp:15960` |
| Compiler wiring | ⚠️ Compiled as zero-arg call into the not-implemented list; no args compiled/passed | `src/compiler.cpp:1745`, symbol at `src/compiler.cpp:5645` |
| Interpreter dispatch | ❌ Missing | — |
| Tag support | N/A (function only) | — |
| Tests | ❌ No `tests/cfm/*spreadsheetformatcellrange*`, no `verify_with_coldfusion.py` coverage | — |
| Tracker status | ❌ `PROGRESS.md:745` (❌ No), listed in `UNIMPLEMENTED_FUNCTIONS.md` (Spreadsheet*) | — |
| Docs/spec | ✅ Spec reference exists | `cfml_docs/CFML_FUNCTION_SPREADSHEETFORMATCELLRANGE.md` |

## What SPREADSHEETFORMATCELLRANGE does at the low C level

Formats a range of cells of a spreadsheet with the given style/format options.
