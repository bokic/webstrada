...
- **Required**: Required
- **Default Value**: *None*
- **Description**: Encrypted string to decrypt.
...
- **Related Functions**: `encrypt`, `cfusion_Decrypt`
- **Coldfusion Support**: Minimum version: `4`. Notes: CF2018+ uses separate `iv` or `salt` named parameters.
- **Lucee Support**: Notes: Uses `IVorSalt` parameter or aliases of `iv` and `salt`.
- **Railo Support**:
- **Openbd Support**:
