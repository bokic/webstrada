# Function Name: `ImageSetDrawingStroke`
...
- **Related Functions**: `ImageDrawText`, `ImageSetAntialiasing`, `ImageSetBackgroundColor`, `ImageSetDrawingColor`, `ImageSetDrawingTransparency`, `IsImageFile`
