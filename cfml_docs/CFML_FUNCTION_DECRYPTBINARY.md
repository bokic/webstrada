...
- **Related Functions**: `encryptBinary`, `decrypt`, `encrypt`
- **Coldfusion Support**: Minimum version: `7.0.1`. Notes: CF2018+ uses separate `iv` or `salt` named parameters.
