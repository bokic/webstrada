...
- **Required**: Required
- **Default Value**: *None*
- **Description**: Binary data to encrypt.
...
- **Related Functions**: `decryptBinary`, `generateSecretKey`
- **Coldfusion Support**: Minimum version: `7.0.1`.
- **Lucee Support**:
- **Railo Support**:
- **Openbd Support**:
